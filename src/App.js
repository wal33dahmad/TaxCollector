    ...
    <div className="container">
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="input-container">
          ...
          <div className="number-container">
            <input
              ...
              name="rate"
              onChange={(e) =>
                formik.setFieldValue("rate", (e.target.value / 100).toFixed(2))
              }
            />
        ...
        <div>
          ...
          />
          <label htmlFor="some">Apply to specific items</label>
        </div>
        <br />
        <hr />
